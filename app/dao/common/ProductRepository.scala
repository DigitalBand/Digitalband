...
trait ProductRepository {
  ...
  def update(product: ProductDetails, brandId: Int, userId: Int)(after: => Unit): Int

  def create(details: ProductDetails, brandId: Int, userId: Int)(after: Int => Unit): Int

  def get0(productId: Int): ProductDetails
