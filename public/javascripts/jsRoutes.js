var jsRoutes = {}; (function(_root){
    ...
    _nS('controllers.admin.StockItem'); _root.controllers.admin.StockItem.list =
        function(productId) {
            return _wA({method:"GET", url:"/" + "admin/product/" + (function(k,v) {return v})("productId", productId) + "/stocks/list"})
        }
